...
import { FaAngleRight, FaFacebookF, FaInstagram, FaLinkedin, FaPlay, FaTwitter } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {sortedData.map((person) => (
          ...
          >
            ...
            <div class="group relative flex justify-center items-center w-60 h-60 mx-auto">
  <img
    src={person.profileImage}
    alt={person.name}
    class="w-52 h-52 object-cover rounded-full transition-transform duration-300 ease-in-out transform group-hover:scale-110"
  />

  <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
    <a href="#" class="absolute top-4 text-white hover:text-blue-500 text-xl transform -translate-x-1/2">
      <FaFacebookF />
    </a>
    <a href="#" class="absolute right-4 text-white hover:text-pink-500 text-xl transform -translate-y-1/2">
      <FaInstagram />
    </a>
    <a href="#" class="absolute bottom-4 text-white hover:text-blue-400 text-xl transform -translate-x-1/2">
      <FaTwitter />
    </a>
    <a href="#" class="absolute left-4 text-white hover:text-green-500 text-xl transform -translate-y-1/2">
      <FaLinkedin />
    </a>
  </div>
</div>
              ...
              <div
                className={`absolute bottom-7 right-20 ${person.color} text-white w-3 h-3 rounded-md`}
              ></div>
            </div>
            <div className="p-4">
              <div className='text-center'>
                <p className="text-xl md:text-2xl text-primary font-bold">{person.name}</p>
                <p className="text-md md:text-lg text-primary font-medium">{person.category}</p>
              </div>
            </div>
          </div>
        ))}
