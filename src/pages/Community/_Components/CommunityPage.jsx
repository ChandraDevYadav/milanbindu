...
import { FaAngleDoubleLeft, FaAngleDoubleRight, FaAngleRight, FaFilter, FaPlay } from 'react-icons/fa';
import { FaAngleLeft, FaSliders, FaX } from 'react-icons/fa6';
...
const CommunityPage = () => {
  ...
  return (
    <div className="container px-4 md:px-28 py-4 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="p-4">
            <h3 className="font-bold text-xl md:text-2xl">{person.title}</h3>
            <div className='flex justify-start items-center gap-2 md:gap-4 mt-3 md:mt-5'>
              <img src={person.storyImage} alt={person.title} className='w-12 md:w-9 h-12 md:h-9 rounded-full' />
              <div>
                <p className="text-lg md:text-xl text-primary font-bold">{person.name}</p>
