...
import { FaAngleDown, FaCartPlus, FaPhone, FaSearch, FaUser, FaUsers } from "react-icons/fa";
  ...
  return (
    <div className="hidden lg:block sticky top-0 z-50 bg-[#f1f7fe]">
      ...
      <div className="col-span-2">
        ...
        <Link to='/login' className="text-white bg-[#ff0461] text-lg font-semibold px-8 py-3 flex justify-start items-center gap-2"><FaUser/>Login</Link>
        <Link to='/signup' className="text-white bg-[#2ba6cb] text-xl font-semibold px-8 py-3 flex justify-start items-center gap-2"><FaUsers/> SignUp</Link>
        </div>
      </div>
    </div>
    </div>
