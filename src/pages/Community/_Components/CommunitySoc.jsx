...
const CommunitySoc = () => {
    return (
        <div className='bg-cover bg-center relative border-b border-gray-400 px-4 md:px-28 py-8 md:py-28' style={{ backgroundImage: "url('/01.jpg')" }}>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                <div>
                    <p className='text-3xl font-medium text-black mb-4'>Newsletter Sign up</p>
                    <div className='relative'>
                        ...
                        <button className='absolute right-2 top-[5px] bg-pink-600 text-white hover:rounded-full py-4 px-5 font-medium rounded-md'>Subscribe Now</button>
                    </div>
                </div>
                <div>
