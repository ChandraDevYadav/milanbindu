    ...
    return (
        <div className='bg-cover bg-center relative px-4 md:px-28 py-8 md:py-28' style={{ backgroundImage: "url('/01.jpg')" }}>
            <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                <div>
                    <p className='text-3xl font-medium text-black mb-4'>About Milan-Bindu</p>
                    <ul className='text-black text-lg font-medium'>
                ...
                <div>
                    <p className='text-3xl font-medium text-black mb-4'>Featured Members</p>
                    <ul className='text-black text-lg font-medium'>
                        <li className='mt-8 flex items-center gap-3'>
                            ...
                            <div>
                                <p className='hover:text-red-600 font-bold'>Samantha Lee</p>
                ...
                <div>
                    <p className='text-3xl font-medium text-black mb-4'>Contacts & Support</p>
                    <ul className='text-black text-lg font-medium'>
                        <li className='mt-8 flex items-center hover:text-red-600'> <FaAngleRight className='text-xl text-black'/> About Us</li>
                        <li className='mt-6 flex items-center hover:text-red-600'><FaAngleRight className='text-xl text-black'/>Our Team</li>
                        <li className='mt-6 flex items-center hover:text-red-600'><FaAngleRight className='text-xl text-black'/>Testimonials</li>
                        <li className='mt-6 flex items-center hover:text-red-600'><FaAngleRight className='text-xl text-black'/>Get in Touch</li>
                        <li className='mt-6 flex items-center hover:text-red-600'><FaAngleRight className='text-xl text-black'/>FAQ</li>
                    </ul>
                </div>
                <div>
                    <p className='text-3xl font-medium text-black mb-4'>Recent Activity</p>
                    <ul className='text-black text-lg font-medium'>
                        <li className='mt-8 flex items-center gap-3'>
